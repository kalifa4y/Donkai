...
export const SettingsPage: React.FC<SettingsPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-8 text-left">
      ...
      {success && (
        <div className="p-4 bg-emerald-50 border border-emerald-200 text-emerald-900 rounded-2xl text-xs font-medium flex items-center gap-2">
      ...
      <form onSubmit={handleSaveProfile} className="space-y-6">
        <div className="bg-white rounded-3xl border border-orange-100/80 shadow-xs p-6 sm:p-7 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-xs font-mono text-gray-500 cursor-not-allowed"
            />
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-xs sm:text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none resize-none leading-relaxed"
            />
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-orange-100/80 shadow-xs p-6 sm:p-7 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none disabled:bg-gray-50 disabled:text-gray-500"
            />
          </div>
      ...
      <div className="bg-white rounded-3xl border border-orange-100/80 shadow-xs p-6 sm:p-7 space-y-4">
        <div className="flex items-center justify-between pb-2 border-b border-gray-100">
          ...
          {profile.verification_status === 'verified' ? (
            ...
            <span className="text-xs font-bold text-gray-400">Non vérifié</span>
          )}
        </div>
        ...
        {profile.verification_status === 'verified' ? (
          ...
          <form onSubmit={handleKycSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-xs outline-none bg-white"
                >
            ...
            <button
              type="submit"
              disabled={saving}
              className="bg-gray-900 hover:bg-gray-800 text-white font-bold text-xs py-2.5 px-4 rounded-xl transition-colors cursor-pointer"
            >
