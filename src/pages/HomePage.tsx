  ...
  return (
    <div className="flex flex-col items-center bg-[#faf9f6] text-gray-900 overflow-hidden">
      ...
      <section className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 pt-12 sm:pt-20 pb-16 sm:pb-24 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-50 border border-orange-200/80 text-orange-950 text-xs font-bold mb-6">
          <Sparkles className="w-3.5 h-3.5 text-orange-600" />
          <span>{t('hero.badge')}</span>
        </div>

        {/* Titre percutant Cal Sans */}
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-heading font-extrabold text-gray-950 tracking-tight max-w-4xl mx-auto leading-[1.1] mb-6">
          {t('hero.title_1')}{' '}
        ...
        <p className="text-sm sm:text-lg text-gray-600 max-w-xl mx-auto mb-8 leading-relaxed font-normal">
          {t('hero.subtitle')}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-14">
          ...
          <a
            href="#how-it-works"
            className="w-full sm:w-auto inline-flex items-center justify-center bg-white border border-gray-200 hover:border-gray-300 text-gray-800 font-bold py-3.5 px-6 rounded-2xl shadow-xs hover:bg-gray-50 transition-all text-sm cursor-pointer"
          >
        ...
        <div className="relative max-w-2xl mx-auto text-left">
          ...
          <div className="relative bg-white rounded-3xl border border-orange-100 shadow-xl p-5 sm:p-7 space-y-5">
            ...
            <div className="flex items-center justify-between gap-3 pb-4 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    <span className="text-sm font-extrabold text-gray-950 font-heading">
                      Projet Eau pour Gao
                    </span>
              ...
              <button
                ...
                className="inline-flex items-center gap-1 text-xs font-bold text-orange-600 hover:text-orange-700 bg-orange-50 hover:bg-orange-100 px-3 py-1.5 rounded-xl transition-colors cursor-pointer"
              >
            ...
            <div className="pt-3 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="bg-gray-50 hover:bg-orange-50 hover:text-orange-700 hover:border-orange-200 text-gray-800 font-bold px-3 py-1.5 rounded-xl border border-gray-200 transition-colors cursor-pointer"
                >
                  +1 000 F
                </button>
                <button
      ...
      <section id="how-it-works" className="w-full bg-white py-20 px-4 sm:px-6 border-y border-gray-100">
        <div className="max-w-5xl mx-auto space-y-12 text-center">
          <div className="max-w-xl mx-auto space-y-2">
            <h2 className="text-2xl sm:text-4xl font-heading font-extrabold text-gray-950 tracking-tight">
              {t('how.title')}
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            {/* Étape 1 : Créez */}
            <div className="p-6 rounded-3xl bg-[#faf9f6] border border-gray-200/70 flex flex-col justify-between space-y-4 hover:border-orange-200 transition-colors">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="w-9 h-9 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center font-bold">
                    <Target className="w-5 h-5" />
                  </div>
                  <span className="text-xs font-bold text-orange-600 uppercase tracking-wider font-heading">
                    Étape 01
                  </span>
                </div>
              ...
              <div className="p-3.5 bg-white rounded-2xl border border-gray-200/60 shadow-2xs space-y-2">
                <div className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                  Aperçu formulaire
                </div>
                <div className="p-2 bg-gray-50 rounded-lg text-xs font-bold text-gray-800 flex justify-between items-center">
                  <span>Objectif</span>
                  <span className="text-orange-600 font-heading">1 500 000 FCFA</span>
                </div>
            ...
            <div className="p-6 rounded-3xl bg-[#faf9f6] border border-gray-200/70 flex flex-col justify-between space-y-4 hover:border-orange-200 transition-colors">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-bold text-amber-600 uppercase tracking-wider font-heading">
                    Étape 02
                  </span>
                </div>
                <h3 className="text-lg font-heading font-extrabold text-gray-950">
              ...
              <div className="p-3.5 bg-white rounded-2xl border border-gray-200/60 shadow-2xs space-y-2">
                ...
                <div className="p-2 bg-gray-50 rounded-lg text-xs font-mono text-gray-700 truncate">
                  donkai.app/@vous/projet
                </div>
                <div className="flex items-center justify-between text-[11px] text-gray-600">
                  <span className="font-bold text-emerald-600">Prêt pour WhatsApp</span>
                  <span className="text-gray-400">1 clic</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-[#faf9f6] border border-gray-200/70 flex flex-col justify-between space-y-4 hover:border-orange-200 transition-colors">
              ...
              <div className="p-3.5 bg-white rounded-2xl border border-gray-200/60 shadow-2xs space-y-2">
                ...
                <div className="p-2 bg-emerald-50 text-emerald-800 rounded-lg text-xs font-bold flex justify-between items-center">
      ...
      <section className="w-full py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto space-y-10 text-center">
          <div className="space-y-2 max-w-xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-heading font-extrabold text-gray-950 tracking-tight">
              {t('showcase.title')}
            </h2>
          ...
          <div className="inline-flex p-1 bg-gray-100 rounded-2xl text-xs font-bold gap-1">
            <button
              type="button"
          ...
          <div className="bg-white rounded-3xl border border-orange-100/80 shadow-md p-6 sm:p-8 text-left max-w-3xl mx-auto">
            {activeShowcaseTab === 'campaign' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-extrabold text-gray-950 font-heading">
                        Forage solaire et eau potable pour Gao
                      </h4>
                      <p className="text-xs text-gray-400">Organisé par Kalifa Coulibaly</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-[#faf9f6] border border-gray-200/60 space-y-2">
                    <span className="text-[11px] text-gray-400 font-bold uppercase">Expérience Donateur</span>
                    <div className="grid grid-cols-4 gap-1.5 pt-1">
                      <span className="p-2 rounded-lg bg-white border border-gray-200 text-center font-bold text-xs">
                        1 000 F
                      </span>
                  ...
                  <div className="p-4 rounded-2xl bg-[#faf9f6] border border-gray-200/60 space-y-2">
                    <span className="text-[11px] text-gray-400 font-bold uppercase">Transparence des frais</span>
                    <div className="space-y-1 text-xs pt-1">
                      <div className="flex justify-between">
                        <span className="text-gray-500">Montant sélectionné</span>
                        <strong className="text-gray-900">2 500 FCFA</strong>
                      </div>
                      <div className="flex justify-between text-gray-500">
                        <span>Frais (5% + 100 F)</span>
                        <span>-225 FCFA</span>
                      </div>
                      <div className="flex justify-between text-emerald-600 font-bold pt-1 border-t border-gray-200">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 rounded-2xl bg-orange-50/60 border border-orange-200/70 space-y-1">
                    <span className="text-[11px] text-orange-900 font-bold uppercase">Solde disponible</span>
                    <p className="text-xl font-heading font-extrabold text-orange-600">
                      420 000 FCFA
                    </p>
                    <span className="text-[10px] text-orange-800">Prêt pour versement</span>
                  </div>
                  <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200/70 space-y-1">
                    <span className="text-[11px] text-gray-500 font-bold uppercase">Total collecté (net)</span>
                    <p className="text-xl font-heading font-extrabold text-gray-950">
                      931 000 FCFA
                    </p>
                    <span className="text-[10px] text-emerald-600 font-bold">64 soutiens</span>
                  </div>
                  <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200/70 space-y-1">
                    <span className="text-[11px] text-gray-500 font-bold uppercase">Sécurité retrait</span>
                    <p className="text-xs font-bold text-gray-900 flex items-center gap-1 mt-1">
                      <Lock className="w-3.5 h-3.5 text-amber-600" />
                      <span>Verrouillé 30j</span>
                    </p>
                    <span className="text-[10px] text-gray-400">Numéro protégé</span>
                  </div>
                </div>

                <div className="p-4 bg-gray-50 rounded-2xl border border-gray-200/60 flex items-center justify-between text-xs">
                  <div>
                    <strong className="text-gray-900">Retrait instantané sur Mobile Money</strong>
                    <p className="text-gray-500 text-[11px]">Compte de réception : Orange Money (+223 70 00 00 00)</p>
                  </div>
                  <span className="bg-gray-900 text-white px-3 py-1.5 rounded-xl font-bold text-[11px]">
            ...
            {activeShowcaseTab === 'profile' && (
              <div className="space-y-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h4 className="text-base font-extrabold text-gray-950 font-heading">
                        Kalifa Coulibaly
                      </h4>
                      <span className="inline-flex items-center gap-1 bg-emerald-50 text-emerald-700 text-[10px] font-bold px-2 py-0.5 rounded-full">
                        <CheckCircle2 className="w-3 h-3" />
                    ...
                    <p className="text-xs text-orange-600 font-mono">@kalifa</p>
                ...
                <div className="pt-3 border-t border-gray-100 flex gap-4 text-xs text-gray-500">
                  <div>
                    <strong className="text-sm font-heading font-extrabold text-gray-900 mr-1">2</strong>
                    collectes actives
                  </div>
                  <div>
                    <strong className="text-sm font-heading font-extrabold text-emerald-600 mr-1">
                      1 450 000 FCFA
                    </strong>
                    mobilisés
                  </div>
      ...
      <section className="w-full bg-white py-20 px-4 sm:px-6 border-y border-gray-100">
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-3xl mx-auto">
            {/* Orange Money */}
            <div className="p-6 rounded-3xl bg-[#faf9f6] border border-gray-200/70 text-center space-y-3 hover:border-orange-300 transition-colors">
              ...
              <h4 className="font-heading font-extrabold text-gray-950 text-base">Orange Money</h4>
            ...
            {/* Wave */}
            <div className="p-6 rounded-3xl bg-[#faf9f6] border border-gray-200/70 text-center space-y-3 hover:border-sky-300 transition-colors">
              <div className="w-12 h-12 rounded-2xl bg-sky-100 text-sky-600 flex items-center justify-center mx-auto font-bold">
                <Smartphone className="w-6 h-6" />
              </div>
              <h4 className="font-heading font-extrabold text-gray-950 text-base">Wave</h4>
            ...
            {/* Moov Money */}
            <div className="p-6 rounded-3xl bg-[#faf9f6] border border-gray-200/70 text-center space-y-3 hover:border-emerald-300 transition-colors">
              <div className="w-12 h-12 rounded-2xl bg-emerald-100 text-emerald-600 flex items-center justify-center mx-auto font-bold">
                <Smartphone className="w-6 h-6" />
              </div>
              <h4 className="font-heading font-extrabold text-gray-950 text-base">Moov Money</h4>
          ...
          <div className="max-w-2xl mx-auto p-5 rounded-3xl bg-gray-50 border border-gray-200/80 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
            <div>
              <span className="text-xl font-heading font-extrabold text-gray-950">0 FCFA</span>
              <p className="text-xs text-gray-500 mt-0.5">Pour créer votre collecte</p>
            </div>
            <div className="border-y sm:border-y-0 sm:border-x border-gray-200 py-2 sm:py-0">
              <span className="text-xl font-heading font-extrabold text-orange-600">5 % + 100 F</span>
              <p className="text-xs text-gray-500 mt-0.5">Par don reçu (frais inclus)</p>
            </div>
            <div>
              <span className="text-xl font-heading font-extrabold text-emerald-600">0 FCFA</span>
              <p className="text-xs text-gray-500 mt-0.5">Frais de retrait Mobile Money</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto space-y-12 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-left">
            <div className="p-7 bg-white rounded-3xl border border-orange-100/70 shadow-xs space-y-3 hover:border-orange-200 transition-colors">
              <div className="flex items-center justify-between">
                <h3 className="text-base font-heading font-extrabold text-gray-950 flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-orange-600" />
                  <span>{t('audience.creators')}</span>
                </h3>
                <span className="text-[10px] font-bold text-gray-400 uppercase">Vidéos & Directs</span>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                {t('audience.creators_desc')}
              </p>
              <div className="flex flex-wrap gap-1.5 pt-1">
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Podcasts</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Matériel vidéo</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Directs TikTok/YT</span>
              </div>
            </div>
            ...
            <div className="p-7 bg-white rounded-3xl border border-orange-100/70 shadow-xs space-y-3 hover:border-orange-200 transition-colors">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-gray-400 uppercase">Culture & Musique</span>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                {t('audience.artists_desc')}
              </p>
              <div className="flex flex-wrap gap-1.5 pt-1">
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Albums</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Clips musicaux</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Expositions</span>
              </div>
            </div>
            ...
            <div className="p-7 bg-white rounded-3xl border border-orange-100/70 shadow-xs space-y-3 hover:border-orange-200 transition-colors">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-gray-400 uppercase">Solidarité</span>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                {t('audience.associations_desc')}
              </p>
              <div className="flex flex-wrap gap-1.5 pt-1">
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Santé</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Éducation</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Kits scolaires</span>
              </div>
            </div>
            ...
            <div className="p-7 bg-white rounded-3xl border border-orange-100/70 shadow-xs space-y-3 hover:border-orange-200 transition-colors">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-gray-400 uppercase">Quartiers & Villages</span>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                {t('audience.projects_desc')}
              </p>
              <div className="flex flex-wrap gap-1.5 pt-1">
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Forages solaires</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Rénovation lieux</span>
                <span className="text-[11px] bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full">Événements</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full bg-white py-20 px-4 sm:px-6 border-y border-gray-100">
        <div className="max-w-4xl mx-auto space-y-10 text-center">
          <div className="space-y-2 max-w-xl mx-auto">
            <div className="w-10 h-10 rounded-2xl bg-gray-950 text-white flex items-center justify-center mx-auto mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 text-left">
            <div className="p-6 bg-[#faf9f6] rounded-3xl border border-gray-200/70 space-y-2.5">
              <div className="w-8 h-8 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center">
                <Lock className="w-4 h-4" />
              </div>
              <h4 className="font-heading font-extrabold text-gray-950 text-sm">
          ...
          <div className="space-y-3 text-left">
            {faqList.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-2xl border border-gray-200/80 overflow-hidden transition-colors"
                >
                  <button
                    type="button"
                  ...
                  >
                    <span className="font-heading font-extrabold text-gray-950 text-sm sm:text-base">
                      {item.question}
                    </span>
                    <ChevronDown
      ...
      <section className="w-full bg-gradient-to-b from-[#faf9f6] to-white py-20 px-4 sm:px-6 border-t border-gray-100 text-center">
        <div className="max-w-xl mx-auto space-y-5">
          <h2 className="text-3xl sm:text-4xl font-heading font-extrabold text-gray-950 tracking-tight">
            {t('cta_final.title')}
          </h2>
